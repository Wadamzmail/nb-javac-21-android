...
import jdkx.lang.model.util.ElementKindVisitor14;
        ...
        if (isRecordField) {
            ...
            if (!appliesToRecords) {
                ...
                if (metadata == null || metadata.isEmpty()) {
                     ...
                     * whether there are SE5 annotations on a VarDef viz openjdk.tools.javac.code.TypeAnnotations.TypeAnnotationPositions.visitVarDef
                     */
                }
            }
        }
