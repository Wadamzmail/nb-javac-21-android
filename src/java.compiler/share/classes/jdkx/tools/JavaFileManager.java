...
public interface JavaFileManager extends Closeable, Flushable, OptionChecker {
     ...
     * {@link #getJavaFileForOutput(jdkx.tools.JavaFileManager.Location, java.lang.String, jdkx.tools.JavaFileObject.Kind, jdkx.tools.FileObject) }
     ...
     * getFileForInput(SOURCE_PATH, "openjdk.tools.javac", "resources/compiler.properties");
     * }
     *
     ...
     *
     * @implSpec The default implementation calls
     * {@link #getFileForOutput(jdkx.tools.JavaFileManager.Location, java.lang.String, java.lang.String, jdkx.tools.FileObject) }
     * with the first element of the {@code originatingFiles}, if any, as a {@code sibling}.
     *
     * @param location an output location
     * @param packageName a package name
